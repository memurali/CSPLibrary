   ...
   <script>
      ...
      $('#submit_search').click(function() {
          ...
          if ((title == '') && (journal == '') && (author == '') && (acronym == '') && (target == '')) {
              ...
              document.frm.action = 'molecular_search';
              document.frm.submit();
          }
      });
         ...
         <div class="grid-x">
                           ...
                           <form id='frm' name='frm'>
                              ...
                              <div class="grid-container">
								 ...
								 <div class="grid-x grid-padding-x">
                                    <div class="large-12 cell">
                                       <label>In use
                                       <input type="checkbox" name="inuse" id="inuse" value="">
                                       </label>
                                    </div>
                                 </div>
                                 <div class="grid-x grid-padding-x">
            ...
            <div class="large-9 cell search-results">
               <div class="grid-x grid-padding-x grid-padding-y">
                  <div class="large-12 cell">
                     <form id='form' name="form" action='molecular_search'>
                  ...
                  <div class="grid-x grid-padding-x grid-padding-y">
                     <div class="large-10 cell">
                        ...
                        <?php 
                           ...
                           {
                            $rowvalue[$i]['j']['Title'] = preg_replace('/[\^£Ç�$?~?|+¬]/', '', $rowvalue[$i]['j']['Title']);
                            ?>
                        <br>
                        <br>
                        <p class="article-title">
                           <!--<a id="articleTitle" href="/CSPLibrary/users/detail?id=<?php echo $rowvalue[$i]['j']['Article_ID'];?> ">
                        ...
                        <ul class="no-bullet">
                           <?php 
                              $rowvalue[$i]['j']['Journal'] = preg_replace('/[\^£Ç�$?~?|+¬]/', '', $rowvalue[$i]['j']['Journal']);
                              $rowvalue[$i]['j']['Author'] = preg_replace('/[\^£Ç�$?~?|+¬]/', '', $rowvalue[$i]['j']['Author']);
                              
                              ?>
                           <li id="authorName">
                              <?php echo $rowvalue[$i]['j']['Author'];?>
                           </li>
                           <li id="journal">
                              <?php echo $rowvalue[$i]['j']['Journal'];?>
                           </li>
                           <?php if($rowvalue[$i]['t']['Target_name'] !='') { ?>
                           <li id="target">
                              <?php echo $checkbox;?>
                              <?php echo $rowvalue[$i]['t']['Target_name'];?>&nbsp;&nbsp;&nbsp;
                              <?php }
